...
Partial Class FormPlaylist
	...
	Private Sub InitializeComponent()
		...
		mnuKelolaPlaylist = New ToolStripMenuItem()
		...
		MenuStrip1.Items.AddRange(New ToolStripItem() {mnuKelolaPlaylist})
		...
		' mnuKelolaPlaylist
		' 
		mnuKelolaPlaylist.Name = "mnuKelolaPlaylist"
		mnuKelolaPlaylist.Size = New Size(115, 21)
		mnuKelolaPlaylist.Text = "Kelola Playlist"
		' 
		' lblKodeJudul
		' 
		...
		lblCariJudul.Location = New Point(20, 275)
		...
		txtSearch.Location = New Point(115, 272)
		...
		btnSimpan.Font = New Font("Calisto MT", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
		btnSimpan.ForeColor = Color.FromArgb(CByte(3), CByte(23), CByte(22))
		btnSimpan.Location = New Point(20, 315)
		...
		btnUbah.Font = New Font("Calisto MT", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
		btnUbah.Location = New Point(130, 315)
		...
		btnHapus.Font = New Font("Calisto MT", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
		btnHapus.Location = New Point(20, 355)
		...
		btnBatal.Font = New Font("Calisto MT", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
		btnBatal.ForeColor = Color.FromArgb(CByte(224), CByte(244), CByte(243))
		btnBatal.Location = New Point(130, 355)
		...
		DataGridViewCellStyle1.Font = New Font("Calisto MT", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
		...
		' lblPlaylistJudul
		' 
		lblPlaylistJudul.ForeColor = Color.FromArgb(CByte(107), CByte(163), CByte(190))
		lblPlaylistJudul.Location = New Point(20, 232)
		lblPlaylistJudul.Name = "lblPlaylistJudul"
		lblPlaylistJudul.Size = New Size(90, 20)
		lblPlaylistJudul.TabIndex = 21
		lblPlaylistJudul.Text = "Playlist"
		' 
		' cmbPlaylist
		' 
		cmbPlaylist.BackColor = Color.FromArgb(CByte(3), CByte(47), CByte(48))
		cmbPlaylist.DropDownStyle = ComboBoxStyle.DropDownList
		cmbPlaylist.ForeColor = Color.FromArgb(CByte(224), CByte(244), CByte(243))
		cmbPlaylist.FormattingEnabled = True
		cmbPlaylist.Location = New Point(115, 229)
		cmbPlaylist.Name = "cmbPlaylist"
		cmbPlaylist.Size = New Size(180, 25)
		cmbPlaylist.TabIndex = 22
		' 
		' FormPlaylist
		' 
	...
	Friend WithEvents lblPlaylistJudul As Label
	Friend WithEvents cmbPlaylist As ComboBox
	Friend WithEvents mnuKelolaPlaylist As ToolStripMenuItem
