Module ValidationModule
    ...
    Public Function ValidasiPlaylist(ep As ErrorProvider,
                                      txtKode As TextBox,
                                      txtNama As TextBox) As Boolean
        Dim kodeValid As Boolean = ValidasiTextBox(ep, txtKode, "Kode Playlist tidak boleh kosong")
        Dim namaValid As Boolean = ValidasiTextBox(ep, txtNama, "Nama Playlist tidak boleh kosong")
        Return kodeValid And namaValid
    End Function
